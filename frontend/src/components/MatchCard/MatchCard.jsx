// // client/src/components/MatchCard/MatchCard.jsx
...
// function MatchCard({ game, telegramId, onBetPlaced }) {
//     const [showBetModal, setShowBetModal] = useState(false);

//     let backgroundImg;
//     switch (game.sportKey) {
//         case 'soccer_epl':
//             backgroundImg = backgroundImgFootball;
//             break;
//         case 'basketball_nba':
//             backgroundImg = backgroundImgBasketball;
//             break;
//         case 'mma_mixed_martial_arts':
//             backgroundImg = backgroundImgUFC;
//             break;
//         default:
//             backgroundImg = backgroundImgFootball;
//     }
...
//         if (onBetPlaced) onBetPlaced(bet, userCoins);
//         setShowBetModal(false);
//     }

//     return (
//         <div onClick={handleOpenBet} className={styles.cardContainer}
//             style={{
...
export default function MatchCard({ game, telegramId, onBetPlaced }) {
    ...
    // 1) Build the logo URL from sportKey, not league
    const leagueLogoUrl = `${process.env.PUBLIC_URL}/SVG Logos/${game.sportKey}.svg`;

    // 2) Pick a background by sportKey
    let backgroundImg;
    switch (game.sportKey) {
        case 'soccer_epl':
            backgroundImg = backgroundImgFootball;
