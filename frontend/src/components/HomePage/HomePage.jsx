        ...
        {showDailyReward && (
          ...
          />
            ...
            <div className={styles.navLinks}>
                ...
                <Link to='/sports/mma_mixed_martial_arts'>
                    <button className={styles.navButton}>MMA</button>
                </Link>
                <Link to='/sports/basketball_nba'>
                    <button className={styles.navButton}>Esports</button>
                </Link>
            </div>
            {loading ? (
                <p>Loading matches...</p>
